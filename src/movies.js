...
function getAllDirectors(arr) {
  const directos = arr.map(function (movie,index, array) {
...
function howManyMovies(movies) {
  ...
  else if(movie.genre.includes('Drama')) { count++ }
  });
  return count
  }
...
function dramaMoviesScore(movies) {
  return dramaMoviesScore(movies.filter(functio (movie) {
